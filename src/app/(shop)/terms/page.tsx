  ...
  return (
    <div className="bg-[#F1F8E4] text-[#4F4A35] font-sans p-5">
      ...
      <div className="max-w-4xl mx-auto p-5 bg-[#F1F8E4]">
        <h1 className="text-center text-4xl mb-5 font-headline">Terms of Service</h1>
        ...
        <h2 className="text-2xl mt-10 font-headline">1. Overview of Services</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">2. Eligibility</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">3. Account Registration</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">4. Orders and Payment</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">5. Pricing</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">6. Delivery and Pickup</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">7. Cancellations and Refunds</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">8. Allergies and Dietary Preferences</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">9. Food Quality and Safety</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">10. Prohibited Activities</h2>
        ...
        <ul className="list-disc pl-5 mb-5">
          <li className="mb-2">Attempting to interfere with the proper functioning of our website or service.</li>
          <li className="mb-2">Providing false or misleading information when placing an order.</li>
          <li className="mb-2">Using our service for any unlawful or fraudulent purposes.</li>
          <li className="mb-2">Attempting to gain unauthorized access to our systems or customer accounts.</li>
        </ul>

        <h2 className="text-2xl mt-10 font-headline">11. Intellectual Property</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">12. Limitation of Liability</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">13. Changes to Terms</h2>
        ...
        <h2 className="text-2xl mt-10 font-headline">14. Contact Information</h2>

        <p className="leading-relaxed mb-5">
          If you have any questions or concerns regarding these Terms, please contact us at:
        </p>

        <p className="leading-relaxed"><strong>Email:</strong> info.bumbaskitchen@gmail.com</p>
        <p className="leading-relaxed mb-5"><strong>Phone:</strong> (+91) 8240-690-254</p>
      </div>
    </div>
  );
}
